    ...
    public void LR_Parse(String IS) {
        ...
        while (true) {
            ...
            if (action.startsWith("s")) {
                ...
                for (int i = 0; i < len; i++) st.remove(st.size() - 1);
